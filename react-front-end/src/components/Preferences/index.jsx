  ...
  if (!open) {
    return (
      <div className='h-full relative preferences-container bg-white flex flex-col '>
        ...
        <Link to='/' onClick={updatePref} className="preferences-header bg-white font-semibold text-lg self-center p-4 rounded-b-xl border border-gray-300 w-full text-center cursor-pointer hover:border-fuchsia-900 hover:text-fuchsia-800 hover:opacity-75 active:bg-fuchsia-800 focus:ring-fuchsia-500" >
          Save
        </Link>
      </div>
    )
